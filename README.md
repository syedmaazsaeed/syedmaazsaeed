...
- Designing voice/text agents and intelligent CRM systems
- Deployed 40+ production-ready AI workflows
- Working remotely with global clients

**Freelance Developer (Upwork)**
- Delivered 20+ custom full-stack applications
- Built AI chatbots and automation solutions
- Worked across legal, healthcare, real estate, and e-commerce sectors

**Web Developer at Codelab IT Solutions**
- Built responsive websites using React.js, HTML, CSS, JavaScript
- Developed backend APIs with Node.js and Express.js
- Collaborated on client projects from design to deployment
